...
<div>
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Pages</a></li>
                ...
                <div class="col-md-9">
                    <div class="widget">
                        ...
                        <div class="innerAll bg-gray border-bottom">
                            ...
                            <h4 class="margin-none">Liste des pages</h4>
                                        ...
                                        <li class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="innerAll half">
                                                    <h4 class="margin-none"><a href="pages.php" class="media-heading strong text-primary">page 1</a></h4>
                                                    <div class="clearfix"></div>
                                ...
                                <div class="col-sm-6 col-xs-8">
                                    <ul class="media-list margin-none">
                                        <li class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="innerAll half">
                                                    <h4 class="margin-none"><a href="pages.php" class="media-heading strong text-primary">page 2</a></h4>
                                                    <div class="clearfix"></div>
                                ...
                                <div class="col-sm-6 col-xs-8">
                                    <ul class="media-list margin-none">
                                        <li class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="innerAll half">
                                                    <h4 class="margin-none"><a href="pages.php" class="media-heading strong text-primary">page 3</a></h4>
                                                    <div class="clearfix"></div>
                                                    <small class="margin-none">Description du groupe</small>
                                                </div>
                                ...
                                <div class="col-sm-6 col-xs-8">
                                    <ul class="media-list margin-none">
                                        <li class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="innerAll half">
                                                    <h4 class="margin-none"><a href="" class="media-heading strong text-primary">page 1</a></h4>
                                                    <div class="clearfix"></div>
                                                    <small class="margin-none">Description ici</small>
                                                </div>
                                ...
                                <div class="col-sm-6 col-xs-8">
                                    <ul class="media-list margin-none">
                                        <li class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="innerAll half">
                                                    <h4 class="margin-none"><a href="" class="media-heading strong text-primary">page 2</a></h4>
                                                    <div class="clearfix"></div>
                                                    <small class="margin-none">Description du groupe</small>
                                                </div>
                                ...
                                <div class="col-sm-6 col-xs-8">
                                    <ul class="media-list margin-none">
                                        <li class="media">
                                            ...
                                            <div class="media-body">
                                                <div class="innerAll half">
                                                    <h4 class="margin-none"><a href="" class="media-heading strong text-primary">page 3</a></h4>
                                                    <div class="clearfix"></div>
                                                    <small class="margin-none">Description du groupe</small>
                                                </div>
