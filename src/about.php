...
<div class="innerAll">
	...
	<div class="cover image ">
		...
		<ul class="list-unstyled">
			<li ><a href="profile.php"><i class="fa fa-fw fa-clock-o"></i> <span>Timeline</span></a></li>
			<li  class="active"><a href="about.php"><i class="fa fa-fw fa-user"></i> <span>About</span></a></li>
				...
				<h3 class="margin-none">About</h3>
					<div class="media innerB">
						<a href="" class="pull-left">
							<img src="../assets/images/people/100/22.jpg" alt="" width="75"/>
						</a>
